...
public class FarmerProblem extends Problem {
    ...
    static final private String INTRO = "A farmer and his wolf, goat, and cabbage "
            + "come to the edge of a river they wish to cross. There is a boat "
            + "at the river's edge that only the farmer can row. The farmer can "
